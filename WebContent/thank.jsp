...
%>
<center>
    <img src="https://shorturl.at/nC178" height=200 width=200><br>
...
<html><head><title>thank you</title>
    ...
    <body>
        ...
        <h4 style="style.css">Thank you for making Order.....<br>
        It will delivered to you within next 10 minutes...</h4>
        
 <footer>
     <div class="jumbotron text-center" style="margin-bottom:0">
        <p class="">Enjoy Your Food.....!</p>
    </div>
 </footer>
</body>
